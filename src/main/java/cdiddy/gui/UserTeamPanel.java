 ...
 * @author cedric
 */
public class UserTeamPanel extends javax.swing.JPanel {

    Team team;
    /**
     * Creates new form UserTeamPanel
     */
    public UserTeamPanel() {
        initComponents();
    }

    public UserTeamPanel(Team t) 
    {
        initComponents();
        setTeam(t);        
    ...
    private void rosterLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rosterLabelMouseClicked
         ( (FantasyFootballFrame) (SwingUtilities.getWindowAncestor(this))).prepareRosterInfo(team.getTeam_key(), "nfl.l."+team.getLeaugeid());
