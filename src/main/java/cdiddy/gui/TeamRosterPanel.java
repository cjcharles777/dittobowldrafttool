...
public class TeamRosterPanel extends javax.swing.JPanel {
    ...
    private YahooLeagueSettings yl;
    private int week;
    ...
    public TeamRosterPanel(TeamService teamservice, PlayerService playerService, GameService gameService, int week) 
    {
        initComponents();
  ...
  /**  public TeamRosterPanel(List<Player> roster) 
    ...
    **/
    ...
    public void populateRoster(String teamId, String leagueid) 
    {
        ...
        yl = gameService.getLeagueSettings(leagueid);
        ...
        {
            Player temp = playerService.retrivePlayer(Integer.parseInt(yahooPlayer.getPlayer_id()));
