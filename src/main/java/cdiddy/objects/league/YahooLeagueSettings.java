...
public class YahooLeagueSettings 
{
    ...
    public YahooLeaugeStatCategories getStat_categories() {
        return stat_categories;
    }

    public void setStat_categories(YahooLeaugeStatCategories stat_categories) {
        this.stat_categories = stat_categories;
    }

    public YahooLeagueStatModifier getStat_modifiers() {
